...
public static class AnimUtils{
    public static void Focus(this Button go,float amount=0.1f,float time=0.2f){
		Focus(go.gameObject,amount,time);
	}

	public static void Focus(this GameObject go,float amount=0.1f,float time=0.2f){
